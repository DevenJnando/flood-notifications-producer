...
try:
    ...
    postcode_geo_data_connection_string = getenv("POSTCODE_GEO_DATA_SQL_CONNECTION_STRING")
except KeyError:
...
def get_az_postcode_geo_data_engine() -> Engine:
    return create_engine("mssql+pyodbc:///?odbc_connect={}".format(postcode_geo_data_connection_string))
